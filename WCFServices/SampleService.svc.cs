...
namespace WCFServices
{
    ...
    // Disabling Address filtering helps with errors due to restrictions at host firewall or address binding. (Revisit the attribute before using in production!)
